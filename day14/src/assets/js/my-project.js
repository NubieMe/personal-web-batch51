        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <div id="tech" class="mb-1">
                        ${dataProject[index].nodeJS}
                        ${dataProject[index].reactJS}
                        ${dataProject[index].nextJS}
                        ${dataProject[index].typescript}
                    </div>
                    <button class="btn btn-dark py-1 fw-bold" style="width: 49%;">edit</button>
                    <button class="btn btn-dark py-1 fw-bold" style="width: 49%;">delete</button>
                </div>
                <div class="card-footer">
                    <small class="text-body-secondary">${getDistanceTime(dataProject[index].postAt)}</small>
                </div>
            </div>
        </div>`
    }
